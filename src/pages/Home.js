        ...
        <div className="home-container">
            ...
            <section className="features-section">
                ...
                <div className='incline-block'> 
                    ...
                    <img src={featureImage} alt="Trading App" />
                    </div>
            ...
            <section className='section-fund'>
                    ...
                    <div className='funded' >
                        <h3>Thousands of traders have already joined our funded trader program, taking their trading careers to the next level. Whether you're aiming to scale up your trading or are just looking for a way to access more capital, we're here to help you succeed</h3>
            ...
            <section className='section-program'>
                ...
                <div className='incline-block'>
                    ...
                    <div className='program-image'>
                        <img src={ProgramImage} alt="Trading App" />
                    </div>
