...
function Dashboard() {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get('https://leverage-x-backend.vercel.app/api/users'); // Get request to fetch users
    ...
    const fetchWatchList1Stocks = async () => {
        try {
            const response = await axios.get('https://leverage-x-backend.vercel.app/api/watchlist1'); // Get request to fetch WatchList1 stocks
    ...
    const fetchWatchList2Stocks = async () => {
        try {
            const response = await axios.get('https://leverage-x-backend.vercel.app/api/watchlist2'); // Get request to fetch WatchList2 stocks
    ...
    const updateUserBalance = async (userId) => {
        ...
        try {
            await axios.put(`https://leverage-x-backend.vercel.app/api/users/balance/${userId}`, { balance }); // PUT request to update balance
    ...
    const addStockToWatchList1 = async () => {
        ...
        try {
            await axios.post('https://leverage-x-backend.vercel.app/api/watchlist1', {
                name: newStockName1,
    ...
    const addStockToWatchList2 = async () => {
        ...
        try {
            await axios.post('https://leverage-x-backend.vercel.app/api/watchlist2', {
                name: newStockName2,
    ...
    const updateStockABWatchList1 = async (stockId) => {
        ...
        try {
            ...
            const response = await axios.put(`https://leverage-x-backend.vercel.app/api/watchlist1/${stockId}`, { A, B });
    ...
    const updateStockABWatchList2 = async (stockId) => {
        ...
        try {
            ...
            const response = await axios.put(`https://leverage-x-backend.vercel.app/api/watchlist2/${stockId}`, { A, B });
